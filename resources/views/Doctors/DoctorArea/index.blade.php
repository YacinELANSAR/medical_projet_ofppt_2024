  ...
  <div class="container-fluid p-0 d-flex h-100">
    ...
    <div class="bg-light flex-fill">
      ...
      <div class="p-4">
        ...
        <span class="fs-1 fw-bold">Bonjour</span> {{ auth()->user()->nom }} {{ auth()->user()->prenom }}
    </div>
    ...
    <div class="table-responsive mt-4">
        <table class="table table-bordered">
            <tbody>
              <tr>
                <td class="text-center text-white" style="background-color: #0A758A;">Nombre de total de votre patients</td>
              </tr>
                <tr>
                    <td class="text-center">{{ $nombrePatients }}</td>
                </tr>
              <tr>
                <td class="text-center text-white" style="background-color: #0A758A;">Nombre de total de Rendez-vous  Termine</td>
              </tr>
                <tr>
                    <td class="text-center">{{ $nombreReservationTermine }}</td>
                </tr>
              <tr>
                <td class="text-center text-white" style="background-color: #0A758A;">Nombre de total de Rendez-vous  Programme</td>
              </tr>
                <tr>
                    <td class="text-center">{{ $nombreReservationProgramme }}</td>
                </tr>
            </tbody>
        </table>
    </div>
