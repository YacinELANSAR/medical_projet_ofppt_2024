...
<head>
    ...
    <title>Modefication Status</title>
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <form class="row g-3" method="post" id="editForm" action="{{ route('reservation.update', $reservation->id) }}" >
                    @csrf
                    @method('PUT')              
                    <input type="hidden" value="{{$reservation->id}}" name="idChangerStatus">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="telephone" value="{{ $client->phone }}" readonly disabled>
                    </div>

                    <div class="col-md-6">
                        <label class="form-label">Date</label>
                        <input type="text" class="form-control" name="date" value="{{ $reservation->jour }}" readonly disabled>
                    </div>
