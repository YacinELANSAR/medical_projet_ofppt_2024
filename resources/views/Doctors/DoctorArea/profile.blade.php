...
<body>
    <div class="container-fluid p-0 d-flex h-100">
        ...
        <form action="{{route('doctors.update',auth()->user()->id)}}" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-floating mb-3">
            <input class="form-control" id="departement" type="text" name="departement" disabled  value="{{ $DepartementDoctorConnecte->libelle }} (-contacter admin pour la modification-)"/>
            <label for="departement">Departement</label>
            <div class="invalid-feedback" data-sb-feedback="departement:required">Departement is required.</div>
          </div>
          <div class="form-floating mb-3">
            <input class="form-control" id="ville" type="text" name="ville" disabled value="{{ $villeDoctorConnecte->libelle }}  (-contacter admin pour la modification-)" />
